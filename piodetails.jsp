...
<div id="menu_items" class="sidenavig" style="position: absolute; top: 120px; left: 0px; width: 0px; height:577px;filter:alpha(opacity=90);opacity:0.9;">
    ...
    <table style="vertical-align:top;width:100%">
         <tr style="width:100%;border-bottom:2px solid whitesmoke ">
          ...
          <tr>
            <td>
                <spring:url value="/pioKnjizenje/${pio.rbr}/details" var="pioActionUrl" />
                ...
                <form:form  class="form-horizontal" method="post" modelAttribute="pio" action="${pioActionUrl}" style="height:1300px">
                      ...
                      <table style="width:100%">
                          <tr style="width:100%">
                              ...
                              <td style="width:20%">
                                    <spring:bind path="id_penzije">
                                            <div>
                                                    <label class="btn-primary"><b>ID PENZIJE:</b></label>
                                                    <div>
                                                            <form:input path="id_penzije" class="form-control" id="id_penzije" placeholder="ID PENZIJE" style="width:95%" />
                                                    </div>
                                            </div>
                                    </spring:bind>
                              </td>
                        ...
                        <tr>
                         <td style="width:10%">&nbsp;</td>
                         <td style="width:20%">
                                <spring:bind path="sifra_obustave">
                                       <div>
                                               <label class="btn-primary"><b>SIFRA OBUSTAVE:</b></label>
                                               <div style="width:100%">
                                                       <form:input path="sifra_obustave" class="form-control" id="sifra_obustave" placeholder="SIFRA OBUSTAVE" style="width:95%" />
                                               </div>
                                       </div>
                               </spring:bind>
                        </td>
                        <td style="width:15%">&nbsp</td>
                        <td style="width:20%">
                            <spring:bind path="racun">
                                    <div>
                                            <label class="btn-primary"><b>PARTIJA:</b></label>
                                            <div style="width:100%">
                                                    <form:input path="racun" class="form-control" id="partija" placeholder="PARTIJA" style="width:95%" />
                                            </div>
                                    </div>
                            </spring:bind>
                        </td>  
                           ...
                           <td style="width:10%">&nbsp;</td>
                            <td style="width:20%">
                                    <spring:bind path="ime">
                                           <div>
                                                   <label class="btn-primary"><b>OPIS:</b></label>
                                                   <div style="width:100%">
                                                           <form:input path="ime" class="form-control" id="ostalo" placeholder="OPIS" style="width:95%" />
                                                   </div>
                                           </div>
                                   </spring:bind>
                            </td>
                        ...
                        <td style="width:10%">&nbsp;</td>   
                        <td style="width:20%">
                                <spring:bind path="iznos">
                                        <div>
                                                <label class="btn-primary"><b>IZNOS:</b></label>
                                                <div>
                                               <div >
                                                        <form:input path="iznos" class="form-control" id="iznos_rate" placeholder="IZNOS" style="width:95%" />
                                               </div>
                                        </div>
                                </spring:bind>   
                        </td>
