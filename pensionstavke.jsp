...
<!--    <link type="text/css" rel="stylesheet" media="screen" href="/PIO/resources/css/bootstrap-datetimepicker.min.css"> 
        ...
        <script type="text/javascript">
            ...
            function GetFormiraneStavke()
            {
                      ...
                      var aa="/PIO/bookingPItems/" + datum + "/" + tip + "/" + idk;
                      form.setAttribute("method", method);
                      form.setAttribute("action", aa);
                      document.body.appendChild(form);
                      form.submit();
             ...
             function SendToTMS()
            {
                      ...
                      var tip=0;
                      tip= $( "#filijale" ).val();
                      if (tip===null || tip==="" || tip===" " || tip==="0" || datum===null || datum==="")
                      {

                        alert("NISTE IZABRALI NIJEDNU FILIJALU I DATUM ZA SLANJE U TMS!!!");
                      }
                      else
                      {
                        localStorage.setItem("DatumUnosaStavki", datum);
                        localStorage.setItem("StavkeFilijala", tip);
                        var aa="/PIO/psendToProcess/" + datum + "/" + tip + "/" + idk;
                        form.setAttribute("method", method);
                        form.setAttribute("action", aa);
                        document.body.appendChild(form);
                        form.submit();
