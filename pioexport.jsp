                                ...
                                <tr style="width:100%;height:100%"> 
                                    ...
                                    <td id="body" style="background-color:azure;vertical-align:top;">
                                        <table style="width:100%">
                                         <tr>
                                            ...
                                            <td>
                                                ...
                                                <h1 style="color:whitesmoke;font-size:20px;text-align:left;">PIO EXPORT::</h1>                                        
                                        ...
                                        <table>
                                                 <tr>
                                                     <td style="width:50px">&nbsp;</td>
                                                     <td style="color:whitesmoke;font-size:16px;font-weight:bold;vertical-align:top;">IZABERI PIO FOND :</td>
                                                     <td style="width:30px"> &nbsp;</td>
                                                     <td><button class="btn-primary" style="height:25px" onclick="window.onbeforeunload = null;PIOBeograd();">PIO BEOGRAD</button></td>
                                                     <td> &nbsp;</td>
                                                     <td><button class="btn-primary" style="height:25px" onclick="window.onbeforeunload = null;PIONoviSad();">PIO VOJVODINA</button></td>
                                                     <td style="width:50px"> &nbsp;</td>
                                                     <td style="color:whitesmoke;font-size:16px;font-weight:bold;vertical-align:top;">UKUPAN IZNOS:</td>
                                                     <td style="width:10px"> &nbsp;</td>
                                                     <td><label id="ukupan_iznos"  style="color:whitesmoke;font-size:16px;font-weight:bold;vertical-align:bottom;"><b>${ukupaniznos}</b></label></td>
                                                 </tr>
                                         </table>
                                        <br/>
                                    <table style="width:100%"> 
                                       ...
                                       <table id="body" style="width:100%;">
                                        <tr>
                                            <td style="width:50px">&nbsp;</td>
                                            <td style="width:180px;color:whitesmoke;"><label>Export For Date ::</label> </td>
                                            <td>
