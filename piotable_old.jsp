        ...
        <div id="Poruka"  class="transparent" style="position: absolute; top: 40%; left: 35%; width: 450px; height:100px; background-color: white; color:darkslategray">
                            ...
                            <table id="body" style="width:100%" >
                                 <tr style="width:100%;border-bottom:2px solid lightgrey ">
                                    ...
                                    <td style="text-align:center;color:lightgrey;font-size:20px;font-family:Arial">
                                        APLIKACIJA OBUSTAVA ::
                                    </td>
                                     <td>
                                ...
                                <tr style="width:100%;height:100%"> 
                                    <!--<td style="background-color:grey;border-right:1px solid silver;border-top:1px solid silver;vertical-align:top; ">-->
                                    ...
                                    <td id="body" style="background-color:azure;vertical-align:top;">
                                        <h1 style="color:lightgrey;font-size:20px;">KNJIZENJE OBUSTAVA ::</h1>
                                        ...
                                        <tr style="border-bottom:1px solid lightgrey;border-right:1px solid lightgrey;border-left:1px solid lightgrey;border-top:1px solid lightgrey;">
                                            ...
                                            <td style="border-right:1px solid lightgrey;"><input type="text" id="prazno1" name="prazno1" style="background-color:gray" value=""/></td>   
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width:80px;color:whitesmoke;border-right:1px solid lightgrey;height:18px;"> 
                                               ...
                                               <td style="border-right:1px solid lightgrey;color:gray"><input type="text" id="prazno" name="prazno" style="background-color:gray" value=""/></td>    
                                           </tr>
                                    </table>
                                               <br/>
                                        ...
                                        <table style="font-size:12px;border-bottom:2px solid lightgrey;border-right:2px solid lightgrey;border-left:2px solid lightgrey;border-top:2px solid lightgrey;width:100%">
                                            <tr>
                                                 ...
                                                 <td><INPUT TYPE="radio" name="piobeograd" id="piobeograd" <%=rad1 %> onclick="KlikBeograd();"></td> <td><label style="color:white;vertical-align:bottom;width:30%">PIO BEOGRAD</label></td>
                                                  <td style="width:10px"> &nbsp;</td>
                                                <td><INPUT TYPE="radio" name="pionovisad" id="pionovisad"  <%=rad2 %> onclick="KlikVojvodina();"></td>  <td><label style="color:white;vertical-align:bottom;width:55%">PIO VOJVODINA</label></td>
                                            </tr>
                                        </table>
                                        <br/>
                                        ...
                                        <br/>
                                         ...
                                         <table style="width:100%;font-size:12px;border-bottom:2px solid lightgrey;border-right:2px solid lightgrey;border-left:2px solid lightgrey;border-top:2px solid lightgrey;">
                                                 <tr>
                                                     <td style="width:15%"><button  class="btn-primary" style="height:25px;color: whitesmoke" onclick="window.onbeforeunload = null;GetHeaderInformation();">PRONADJI UPLATU</button></td>
                                                     <td style="width:0.5%"> &nbsp;</td>
                                                     <td style="width:15%"><button  class="btn-primary" style="height:25px;color: whitesmoke" onclick="window.onbeforeunload = null;PIOBeograd();">EXPORT U FAJL</button></td>
                                                     <td style="width:0.5%"> &nbsp;</td>
                                                     <td style="width:15%"> <button  class="btn-primary" style="height:25px;color: whitesmoke" onclick="window.onbeforeunload = null;CekirajRacune();">PROVERI RACUNE</button></td>
                                                     <td style="width:0.5%"> &nbsp;</td>
