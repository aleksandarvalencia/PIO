...
<!--    <link type="text/css" rel="stylesheet" media="screen" href="/PIO/resources/css/bootstrap-datetimepicker.min.css"> 
        ...
        <script type="text/javascript">
            ...
            {
                document.getElementById("bookDate").value=localStorage.getItem("DatumUnosaStavki");
                document.getElementById("filijale").value=localStorage.getItem("StavkeFilijala");
            ...
            function GetFormiraneStavke()
            {
                      ...
                      tip= $( "#filijale" ).val();
                      localStorage.setItem("DatumUnosaStavki", datum);
                      localStorage.setItem("StavkeFilijala", tip);
                      var aa="/PIO/bookingItems/" + datum + "/" + tip + "/" + idk;
                      form.setAttribute("method", method);
                      form.setAttribute("action", aa);
                      document.body.appendChild(form);
                      form.submit();
             ...
             function SendToTMS()
            {
                      ...
                      localStorage.setItem("DatumUnosaStavki", datum);
                      localStorage.setItem("StavkeFilijala", tip);
                      var aa="/PIO/sendToProcess/" + datum + "/" + tip + "/" + idk;
                      form.setAttribute("method", method);
                      form.setAttribute("action", aa);
                      document.body.appendChild(form);
                      form.submit();
...
<div id="WaitingProcess"  class="transparent" style="border:#000000 solid 1px;position: absolute;  top: 40%; left: 35%; width: 500px; height:140px; background-color: white; color:darkslategray;filter:alpha(opacity=80);opacity:0.8;">
 ...
 <c:if test="${informacija!=''}">
        <div id="Poruka"  class="transparent" style="position: absolute; top: 350px; left: 400px; width: 450px; height:100px; background-color: white; color:darkslategray">
                            ...
                            <input type="hidden" id="idk" name="idk" value="${pio_idk}"/> 
                            <table id="body" style="width:100%" >
                                ...
                                <tr style="width:100%;vertical-align:top;">
                                    <td id="body" style="background-color:azure;vertical-align:top;">
                                        <table style="width:100%">
                                         <tr>
                                            ...
                                            <td>
                                                ...
                                                <h1 style="color:whitesmoke;font-size:20px;text-align:left;">STAVKE ZA KNJIZENJE::</h1>                                        
                                            ...
                                            <td>
                                                    ...
                                                    <div id="importedfilesdate" >
                                                            ...
                                                            <div class="input-append date" >
                                                                <input type="text" id="bookDate"  name="bookDate" style="width:100px;height:20px"/>
                                                            <span class="add-on">
                                        ...
                                        <tr>
                                            <td style="width:50px">&nbsp;</td>
                                            <td style="width:350px;color:whitesmoke;"><label>FORMIRANO STAVKI NA 0003191390000017::</label> </td>
                                        ...
                                        <tr>
                                            <td style="width:50px">&nbsp;</td>
                                            <td style="width:350px;color:whitesmoke;"><label>FORMIRANO NA 0003191390000021::</label> </td>
                                        ...
                                        <tr>
                                             <td style="width:50px">&nbsp;</td>
                                            <td><button  style="height:25px;background-color: maroon;color: whitesmoke" onclick="window.onbeforeunload = null;GetFormiraneStavke();">STAVKE KNJIZENJA</button></td>
                                            <td><button  style="height:25px;background-color: maroon;color: whitesmoke" onclick="window.onbeforeunload = null;SendToTMS();">POSALJI U TMS</button></td>
                                             <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        </table>
